  ...
  return (
    <>
      <div className="container my-3">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to GalaxyBuilder-oss Portfolio.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to GalaxyBuilder-oss Portfolio,
              accessible from{" "}
              <a
        ...
        <ul>
          <li>
            <p>By email: <a href="mailto:hidayatsalim004@outlook.com">hidayatsalim004@outlook.com</a></p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>By phone number: +6285314793866</p>
          </li>
        </ul> 
      </div>
    </>
